...
#define STRING_CONFIG_H_AUTHOR "(just-jason & j54n1n, PowerWASP)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // PowerWASP (2nd generation printhead)
...
#define EXTRUDE_MAXLENGTH 500 // Allowable length for filament change.
...
// PowerWASP has also MAX endstops.
...
#define X_HOME_DIR -1
#define Y_HOME_DIR -1
#define Z_HOME_DIR 1  // Home always with Z_MAX endstop.

// @section machine

// The size of the print bed
#define X_BED_SIZE 261.4
#define Y_BED_SIZE 193.9
...
//#define MIN_SOFTWARE_ENDSTOPS // PowerWASP has hardware endstops.
...
//#define MAX_SOFTWARE_ENDSTOPS // PowerWASP has hardware endstops.
